...
rr_str <- c()
reduced_recovery_rates <- recovery_rates[(recovery_rates$global_recovery_rate>0.3),]
...
legend("topright",bty='n',title="Recovery Rates (>0.3)",cex=.7,legend=rr_str,text.col="blue")
text(0.5,58.5,
