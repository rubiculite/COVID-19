...
plot(
     as.Date(dw$date,"%m-%d-%Y"),dw$death_rate,
     xlab = 'Days',
     ylab='% Outcome',
     ylim=c(0,100),
...
legend("topright",bty='n',title=sprintf("Recovery Rates (>%s%%)",chop),cex=.7,legend=rr_str,text.col="blue")
text(as.Date(dw$date,"%m-%d-%Y")[1],58.5,
